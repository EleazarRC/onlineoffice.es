<div class="video">
    ...
    <section>
        ...
        <div id="caracteristicas">        
            ...
            <div>
                ...
                <button class="boton-login sombra" onclick="document.location='https://github.com/EleazarRC/onlineoffice.es'"> repositorio</button>
            </div>
            <div>
                ...
                <button class="boton-login sombra" onclick="document.location='https://github.com/EleazarRC/onlineoffice.es/blob/main/LICENSE'"> Descarga</button>
            </div>
    ...
    <script src="/build/js/animacionesInicio.js"></script>